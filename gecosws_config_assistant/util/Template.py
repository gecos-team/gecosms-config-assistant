    ...
    def save(self):
        ...
        try:
            ...
            if sys.platform == 'win32':
                # Check owner and permissions in Windows systems
                # TODO!
                self.logger.info("TODO! check owner and permissions in Windows systems")

            else:
                # Check owner and permissions in Linux systems
                import grp
                import pwd
